    ...
    def test_life_os_tools_register_after_existing_core_surface(self):
        ...
        self.assertEqual(
            [
                ...
                "donggu_fde_community_recovery_status", "donggu_fde_community_plan",
                "donggu_fde_community_receipt_status", "donggu_fde_community_apply",
                "donggu_fde_community_recover", "donggu_fde_community_readback",
                "donggu_fde_community_revoke", "donggu_fde_community_ack",
