...
- 두 맥락이 모두 나타나면 사용자가 명시한 페르소나가 우선한다. 명시한 페르소나가 없고 요청/브리프가 주장과 독자를 소유하는 주 관점을 분명히 하면 주 페르소나를 정확히 하나 선택한다. 주 관점이 불명확하고 선택이 논지를 바꾸면 `FDE와 1인 빌더 중 어떤 페르소나로 쓸까요?`라고 묻는다.
