...
1. **VOICE** — `obsidian:read 1_SNS/X/01_VOICE - X.md`
   → 한국어 풀(명사형) / 영어 풀(indie hacker) 분리

2. **CHANNEL_GUIDE** — `obsidian:read 1_SNS/X/00_CHANNEL_GUIDE - X.md`
   → 외부 링크 페널티, Premium 효과, 발행 시간

3. **WINNING_PATTERNS** — `obsidian:read 1_SNS/X/02_WINNING_PATTERNS - X.md`
