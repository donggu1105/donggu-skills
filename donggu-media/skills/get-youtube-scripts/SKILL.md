...
description: Use when given a YouTube URL (watch, youtu.be, shorts, live) and you need the video's transcript / captions / 자막 / 스크립트 as clean text — to summarize (요약), translate, quote, or analyze it. Captions-only, no audio transcription.
---
